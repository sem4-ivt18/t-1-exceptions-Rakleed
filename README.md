...
- [ИСР № 1](#инвариативная-самостоятельная-работа--1)
    ...
    - [3 задание](#13-дополнить-программу-для-считывания-данных-с-использованием-менеджера-контекстов-и-реализацией-расширенного-синтаксиса-для-обработки-исключений)
